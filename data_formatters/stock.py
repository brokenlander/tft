...
# Lint as: python3
"""Custom formatting functions for stock market dataset.
...
class StockFormatter(GenericDataFormatter):
  """Defines and formats data for the stock market dataset.
  Attributes:
  ...
  _column_definition = [
      ...
      ('daysfromstart', DataTypes.REAL_VALUED, InputTypes.TIME),
      ...
      ('categorical_symbol', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT)
  ]
  ...
  def split_data(self, df, valid_boundary='2020-01-01', test_boundary='2022-01-01'):
